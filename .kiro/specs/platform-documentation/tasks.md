...
- [x] 1. Criar o README.md com cabeçalho e seção de Visão Geral da Plataforma
...
- [x] 2. Adicionar seção "Como Subir a Plataforma"
...
- [x] 3. Adicionar seção de Referência de Endpoints
  - [x] 3.1 Documentar endpoints do Authorization Server
  ...
  - [x] 3.2 Documentar endpoints do Client Registry
  ...
  - [x] 3.3 Documentar endpoints do OIDC Provider, UMA Server e Scope Manager
...
- [x] 4. Adicionar seção de Integração — Authorization Code + PKCE
...
- [x] 5. Adicionar seção de Integração — Client Credentials
...
- [x] 6. Adicionar seção de Integração — UMA 2.0
...
- [x] 7. Adicionar seção de Variáveis de Ambiente
...
- [x] 8. Adicionar seção de Observabilidade
...
- [x] 9. Checkpoint final — Verificar completude do README
